...
if [[ -d "$A2/$TARGET_FOLDER" ]]; then
    cp -r "$A2/$TARGET_FOLDER"/app.js "$A2/"
    cp -r "$A2/$TARGET_FOLDER"/hy2ip.sh "$A2/"
    cp -r "$A2/$TARGET_FOLDER"/install.sh "$A2/"
    cp -r "$A2/$TARGET_FOLDER"/ota.sh "$A2/"
    cp -r "$A2/$TARGET_FOLDER"/.env "$A2/"
    cp -r "$A2/$TARGET_FOLDER"/log.html "$A2/"
    cp -r "$A2/$TARGET_FOLDER"/node.html "$A2/"
    cp -r "$A2/$TARGET_FOLDER"/proxy.conf "$A2/"
    cp -r "$A2/$TARGET_FOLDER"/readme.txt "$A2/"
    cp -r "$A2/$TARGET_FOLDER"/start.sh "$A2/"
    cp -r "$A2/$TARGET_FOLDER"/info.html "$A2/"
